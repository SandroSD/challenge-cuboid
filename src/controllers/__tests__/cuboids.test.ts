...
describe('cuboid update', () => {
  ...
  it('should fail to update if bag does not found and return 404 status code', async () => {
    cuboid.bagId = 999;
  ...
  it('should fail to update if cuboid does not found and return 404 status code', async () => {
    const response = await request(server)
      .put(urlJoin('/cuboids', '999'))
      .send(cuboid);
